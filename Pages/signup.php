    ...
    <div class="bg-white w-96 h-96 rounded-3xl shadow-lg flex flex-col">
        ...
        <form>
            <div class="flex flex-col mx-20 gap-4">
                ...
                <input class="w-full p-2 border-b-2 outline-0" type="password" placeholder="Mot de passe" name="psw"
                    required>
                <input class="w-full p-2 border-b-2 outline-0" type="password" placeholder="Confirmer mot de passe"
                    name="psw2" required>
                <button
